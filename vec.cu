...
**************************OUTPUT*******************************
Vector generation: 3.77238 sec

GPU:	  Transfer to GPU: 0.31229 sec
	 Kernel execution: 0.17117 sec
	Transfer from GPU: 0.35805 sec
	            Total: 0.84237 sec

CPU: 0.44495 sec

CPU outperformed GPU by 1.89x
